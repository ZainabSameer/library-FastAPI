...
from serializers.book import BookSchema, BookCreate as BookCreateSchema , BookUpdate
...
def update_book(book_id: int, book: BookUpdate, db: Session = Depends(get_db), current_user: UserModel = Depends(get_current_user)):
    ...
    book_data = book_data = book.model_dump(exclude_unset=True)
